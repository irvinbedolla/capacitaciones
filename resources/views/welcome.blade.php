    ...
    <main class="py-5 bg-light">
        <div class="container">
            ...
            <section class="cursos-destacados">
                <h2 class="mb-4 border-bottom pb-2">Próximos Seminarios Disponibles</h2>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <div class="card-body">
                              <img 
                                src="public/assets/images/index/4.jpg" 
                            ...
                            <div class="card-footer bg-white border-0">
                                ...
                                <button type="button" class="btn btn-outline-primary w-100 mt-2" data-bs-toggle="modal" data-bs-target="#Seminario1">
                                    Ver Detalles
                                </button>
                                <div class="modal fade" id="Seminario1" tabindex="-1" aria-labelledby="semblanzaModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered">
                                      <div class="modal-content">
                                          
                                          <div class="modal-header">
                                              <h5 class="modal-title" id="semblanzaModalLabel">Detalle</h5>
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <div class="card-body">
                                <img 
                                  src="public/assets/images/index/5.jpg" 
                                  class="img-fluid rounded mb-3 shadow-sm" 
                                  alt="Imagen representativa del curso de Conciliación Laboral">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <div class="card-body">
                              <img 
                                  src="public/assets/images/index/6.jpg" 
                                  class="img-fluid rounded mb-3 shadow-sm" 
                                  alt="Imagen representativa del curso de Conciliación Laboral">
